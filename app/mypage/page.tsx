        ...
        <>
            ...
            <section className="max-w-[1440px] mx-auto my-[10px]">
                ...
                <div className="mb-[30px] flex gap-[40px]">
                    <Button className="rounded-full w-[144px] h-[41px] bg-[#FDE48D] text-[#725C10] text-[16px]">リクエスト中</Button>
                    <Button className="rounded-full w-[144px] h-[41px] bg-[#B1FF9D] text-[#21770B] text-[16px]">承認済み</Button>
                    <Button className="rounded-full w-[144px] h-[41px] bg-[#FFC2C5] text-[#9D0E14] text-[16px]">拒否</Button>
                </div>
