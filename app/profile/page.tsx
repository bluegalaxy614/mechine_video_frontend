...
export default function PostPage() {
  return (
    <div className="w-full flex mt-[85px] flex-col h-[100vh] w-[1440px]">
        ...
        <div className="w-full flex flex-col">
          ...
          <div className="flex mt-[40px] space-x-12">
            ...
            <div className="w-[554px] h-[370px] rounded-[24px] bg-[#F4F4F4] pt-[49px] pb-[46px] pl-[55px] pr-[59px]">
              <h1 className="text-[24px] text-[#4291EF] font-bold mb-[13px]">無料プラン</h1>
              <Divider className="bg-[#4291EF]" />
              <p className="w-[440px] h-[140px] text-[#999999] text-[20px] mt-[25px]">すべての動画を視聴可能ですが、各動画の視聴時間は10秒に制限されています。ただし、2025年12月末まで、無料プランでも全動画を制限なしで視聴できます。</p>
              <Button className="w-[185px] h-[31px] bg-[#4291EF] mt-[40px] mb-[71px]">
                <p className="text-[#FFFFFF] text-[20px]">アップデート</p>
                <img src="/icons/icon-store.png" alt="" />
              </Button>
