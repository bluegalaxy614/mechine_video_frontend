  ...
  return (
    <div className="relative flex w-full h-[545px]">
      <div className="absolute top-0 left-[61px] flex justify-center items-center gap-9">
        <img className="w-[39px] h-[39px]" src="/icons/icon-chart.png" alt="chart icon" />
      ...
      <div className="mx-auto mb-8 w-full">
        <Line
          ...
          options={{
            responsive: true,
            maintainAspectRatio: false, // Optional: allows chart to scale properly
            plugins: {
              legend: {
                position: "top",
                labels: {
                  color: "#FFFFFF", // Optional: Customize legend labels color
                  boxWidth: 20, // Optional: Customize size of legend color box
                },
              },
              title: {
                display: true,
