...
const HomeFooter = () => {
  return (
    <div className="flex flex-col items-center justify-center w-full h-[532px] relative">
      ...
      />
      <div className="absolute flex w-full h-full top-0 lg:px-[0px] md:px-[40px] sm:px-[20px] xsm:px-[10px]">
        <div className="flex flex-col max-w-[643px] mx-auto my-auto justify-start items-start gap-6">
        ...
        <div className="flex flex-col max-w-[643px] h-[209px] mx-auto my-auto justify-start items-start gap-12">
          <div className="flex justify-center items-center h-[40px]">
            <div className="flex justify-center items-center h-[40px] gap-4">
              <img
                ...
                className="h-[40px]"
              />
              <p className="text-[24px] font-bold text-[#C7C7C7] lg:invisible md:invisible sm:hidden xsm:hidden">電話番号</p>
            </div>
          ...
          <div className="flex justify-center items-center h-[40px]">
            <div className="flex justify-center items-center h-[40px] gap-4">
              <img
                ...
                className="h-[40px]"
              />
              <p className="text-[24px] font-bold text-[#C7C7C7] lg:invisible md:invisible sm:hidden xsm:hidden">メールアドレス</p>
            </div>
          ...
          <div className="flex justify-center items-center h-[40px]">
            <div className="flex justify-center items-center h-[40px] gap-4">
              <img
                ...
                className="h-[40px]"
              />
              <p className="text-[24px] font-bold text-[#C7C7C7] lg:invisible md:invisible sm:hidden xsm:hidden">所在地</p>
            </div>
